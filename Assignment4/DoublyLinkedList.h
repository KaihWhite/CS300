#ifndef ASSIGNMENT4_DOUBLY_LINKED_LIST_H
#define ASSIGNMENT4_DOUBLY_LINKED_LIST_H
...
public:
    ...
    //copy constructor
    DoublyLinkedList(const DoublyLinkedList<T>& o);
    ...
    template <class U>
    friend ostream& operator<<(ostream& out, const DoublyLinkedList<U> &o);

    //overloading operator>>
    template <class U>
    friend istream& operator>>(istream& in, DoublyLinkedList<U> &o);
